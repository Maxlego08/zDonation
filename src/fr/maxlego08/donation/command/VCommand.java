package fr.maxlego08.donation.command;
...
import fr.maxlego08.donation.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
	...
	public CommandType prePerform(ZDonationPlugin main, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(ZDonationPlugin main);
	 ...
	 * @return
	 */
	public List<String> toTab(ZDonationPlugin plugin, CommandSender sender2, String[] args) {
		return null;
	}

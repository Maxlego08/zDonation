package fr.maxlego08.donation.inventory;
...
import fr.maxlego08.donation.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.donation.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.donation.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected ZDonationPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ZDonationPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZDonationPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ZDonationPlugin plugin, Player player) {
	}
